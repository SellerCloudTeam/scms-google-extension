window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#00ffff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#00ffff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#00ffff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#00ffff"},
    {selector: '#fldsetAdvanced', borderColor: '#00ffff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#00ffff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#00ffff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#00ffff'},
    {selector: '#lblTicketDescription p a', textColor: '#00ffff'},
    {selector: '#lblTicketDescription a', textColor: '#00ffff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#00ffff'},
    {selector: '#lblTicketDescription p strong', textColor: '#00ffff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#00ffff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#00ffff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#00ffff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#00ffff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#00ffff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#00ffff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#00ffff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#00ffff'},
    {selector: '#collapse_2 p strong', textColor: '#00ffff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#00ffff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#00ffff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#00ffff'},
    {selector: 'table.grid tbody tr td a', textColor: '#00ffff'},
    {selector: 'table.grid tbody tr td u', textColor: '#00ffff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#00ffff'},
    {selector: '.footer .wrapper p span', textColor: '#00ffff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#00ffff'},
    {selector: '.button2', color: '#333', borderColor: '#00ffff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#00ffff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#00ffff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#00ffff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#00ffff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#00ffff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#00ffff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#00ffff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#00ffff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#00ffff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#00ffff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#00ffff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#00ffff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#00ffff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#00ffff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#00ffff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#00ffff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#00ffff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#00ffff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#00ffff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#00ffff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#00ffff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#00ffff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#00ffff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#00ffff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#00ffff'},
    {selector: '#tblEstimates_ID div', textColor: '#00ffff'},
    {selector: '#tblEstimates_Name div', textColor: '#00ffff'},
    {selector: '#tblEstimates_StringField div', textColor: '#00ffff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#00ffff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#00ffff'},
    {selector: '#tab1_pane ul li a', textColor: '#00ffff'},
    ...
    {selector: '#tab7_pane div', textColor: '#00ffff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#00ffff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#00ffff'},
    {selector: '#lblHeadingText', textColor: '#00ffff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#00ffff'},
    {selector: '#lblMaxRec', textColor: '#00ffff'},
    {selector: '#divNote', textColor: '#00ffff'},
    ...
    {selector: '#createBy b', textColor: '#00ffff'},
    ...
    {selector: '.left label', textColor: '#00ffff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#00ffff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#00ffff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#00ffff'},
    {selector: '#mLabel', textColor: '#00ffff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#00ffff'},
    ...
    {selector: 'td a', textColor: '#00ffff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#00ffff'},
