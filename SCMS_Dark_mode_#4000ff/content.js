window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#4000ff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#4000ff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#4000ff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#4000ff"},
    {selector: '#fldsetAdvanced', borderColor: '#4000ff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#4000ff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#4000ff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#4000ff'},
    {selector: '#lblTicketDescription p a', textColor: '#4000ff'},
    {selector: '#lblTicketDescription a', textColor: '#4000ff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#4000ff'},
    {selector: '#lblTicketDescription p strong', textColor: '#4000ff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#4000ff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#4000ff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#4000ff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#4000ff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#4000ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#4000ff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#4000ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#4000ff'},
    {selector: '#collapse_2 p strong', textColor: '#4000ff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#4000ff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#4000ff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#4000ff'},
    {selector: 'table.grid tbody tr td a', textColor: '#4000ff'},
    {selector: 'table.grid tbody tr td u', textColor: '#4000ff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#4000ff'},
    {selector: '.footer .wrapper p span', textColor: '#4000ff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#4000ff'},
    {selector: '.button2', color: '#333', borderColor: '#4000ff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#4000ff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#4000ff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#4000ff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#4000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#4000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#4000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#4000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#4000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#4000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#4000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#4000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#4000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#4000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#4000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#4000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#4000ff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#4000ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#4000ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#4000ff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#4000ff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#4000ff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#4000ff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#4000ff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#4000ff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#4000ff'},
    {selector: '#tblEstimates_ID div', textColor: '#4000ff'},
    {selector: '#tblEstimates_Name div', textColor: '#4000ff'},
    {selector: '#tblEstimates_StringField div', textColor: '#4000ff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#4000ff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#4000ff'},
    {selector: '#tab1_pane ul li a', textColor: '#4000ff'},
    ...
    {selector: '#tab7_pane div', textColor: '#4000ff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#4000ff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#4000ff'},
    {selector: '#lblHeadingText', textColor: '#4000ff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#4000ff'},
    {selector: '#lblMaxRec', textColor: '#4000ff'},
    {selector: '#divNote', textColor: '#4000ff'},
    ...
    {selector: '#createBy b', textColor: '#4000ff'},
    ...
    {selector: '.left label', textColor: '#4000ff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#4000ff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#4000ff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#4000ff'},
    {selector: '#mLabel', textColor: '#4000ff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#4000ff'},
    ...
    {selector: 'td a', textColor: '#4000ff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#4000ff'},
