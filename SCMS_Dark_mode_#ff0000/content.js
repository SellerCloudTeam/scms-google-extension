window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#ff0000';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#ff0000"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#ff0000"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#ff0000"},
    {selector: '#fldsetAdvanced', borderColor: '#ff0000'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#ff0000'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#ff0000'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#ff0000'},
    {selector: '#lblTicketDescription p a', textColor: '#ff0000'},
    {selector: '#lblTicketDescription a', textColor: '#ff0000'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#ff0000'},
    {selector: '#lblTicketDescription p strong', textColor: '#ff0000'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#ff0000'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#ff0000'},
    ...
    {selector: '#TicketDescription strong', textColor: '#ff0000'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#ff0000'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#ff0000'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff0000'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#ff0000'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff0000'},
    {selector: '#collapse_2 p strong', textColor: '#ff0000'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#ff0000'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#ff0000'},
    {selector: 'table.grid tbody tr td strong', textColor: '#ff0000'},
    {selector: 'table.grid tbody tr td a', textColor: '#ff0000'},
    {selector: 'table.grid tbody tr td u', textColor: '#ff0000'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#ff0000'},
    {selector: '.footer .wrapper p span', textColor: '#ff0000'},
    ...
    {selector: '.button', color: '#333', borderColor: '#ff0000'},
    {selector: '.button2', color: '#333', borderColor: '#ff0000', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#ff0000'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#ff0000'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#ff0000'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#ff0000'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#ff0000'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#ff0000'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#ff0000'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#ff0000'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#ff0000'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#ff0000'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#ff0000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#ff0000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#ff0000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#ff0000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#ff0000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#ff0000'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#ff0000'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#ff0000'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#ff0000'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#ff0000'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#ff0000'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#ff0000'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#ff0000'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#ff0000'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#ff0000'},
    {selector: '#tblEstimates_ID div', textColor: '#ff0000'},
    {selector: '#tblEstimates_Name div', textColor: '#ff0000'},
    {selector: '#tblEstimates_StringField div', textColor: '#ff0000'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#ff0000'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#ff0000'},
    {selector: '#tab1_pane ul li a', textColor: '#ff0000'},
    ...
    {selector: '#tab7_pane div', textColor: '#ff0000'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#ff0000'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#ff0000'},
    {selector: '#lblHeadingText', textColor: '#ff0000'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#ff0000'},
    {selector: '#lblMaxRec', textColor: '#ff0000'},
    {selector: '#divNote', textColor: '#ff0000'},
    ...
    {selector: '#createBy b', textColor: '#ff0000'},
    ...
    {selector: '.left label', textColor: '#ff0000'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#ff0000'},
    ...
    {selector: '#litIsLiveDate', textColor: '#ff0000'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#ff0000'},
    {selector: '#mLabel', textColor: '#ff0000'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#ff0000'},
    ...
    {selector: 'td a', textColor: '#ff0000'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#ff0000'},
