window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#8000ff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#8000ff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#8000ff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#8000ff"},
    {selector: '#fldsetAdvanced', borderColor: '#8000ff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#8000ff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#8000ff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#8000ff'},
    {selector: '#lblTicketDescription p a', textColor: '#8000ff'},
    {selector: '#lblTicketDescription a', textColor: '#8000ff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#8000ff'},
    {selector: '#lblTicketDescription p strong', textColor: '#8000ff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#8000ff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#8000ff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#8000ff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#8000ff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#8000ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#8000ff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#8000ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#8000ff'},
    {selector: '#collapse_2 p strong', textColor: '#8000ff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#8000ff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#8000ff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#8000ff'},
    {selector: 'table.grid tbody tr td a', textColor: '#8000ff'},
    {selector: 'table.grid tbody tr td u', textColor: '#8000ff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#8000ff'},
    {selector: '.footer .wrapper p span', textColor: '#8000ff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#8000ff'},
    {selector: '.button2', color: '#333', borderColor: '#8000ff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#8000ff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#8000ff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#8000ff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#8000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#8000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#8000ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#8000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#8000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#8000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#8000ff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#8000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#8000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#8000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#8000ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#8000ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#8000ff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#8000ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#8000ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#8000ff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#8000ff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#8000ff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#8000ff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#8000ff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#8000ff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#8000ff'},
    {selector: '#tblEstimates_ID div', textColor: '#8000ff'},
    {selector: '#tblEstimates_Name div', textColor: '#8000ff'},
    {selector: '#tblEstimates_StringField div', textColor: '#8000ff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#8000ff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#8000ff'},
    {selector: '#tab1_pane ul li a', textColor: '#8000ff'},
    ...
    {selector: '#tab7_pane div', textColor: '#8000ff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#8000ff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#8000ff'},
    {selector: '#lblHeadingText', textColor: '#8000ff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#8000ff'},
    {selector: '#lblMaxRec', textColor: '#8000ff'},
    {selector: '#divNote', textColor: '#8000ff'},
    ...
    {selector: '#createBy b', textColor: '#8000ff'},
    ...
    {selector: '.left label', textColor: '#8000ff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#8000ff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#8000ff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#8000ff'},
    {selector: '#mLabel', textColor: '#8000ff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#8000ff'},
    ...
    {selector: 'td a', textColor: '#8000ff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#8000ff'},
