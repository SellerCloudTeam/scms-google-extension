window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#80ff00';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#80ff00"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#80ff00"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#80ff00"},
    {selector: '#fldsetAdvanced', borderColor: '#80ff00'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#80ff00'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#80ff00'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#80ff00'},
    {selector: '#lblTicketDescription p a', textColor: '#80ff00'},
    {selector: '#lblTicketDescription a', textColor: '#80ff00'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#80ff00'},
    {selector: '#lblTicketDescription p strong', textColor: '#80ff00'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#80ff00'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#80ff00'},
    ...
    {selector: '#TicketDescription strong', textColor: '#80ff00'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#80ff00'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#80ff00'},
    ...
    {selector: '#collapse_2 strong', textColor: '#80ff00'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#80ff00'},
    {selector: '#collapse_2 a', textColor: 'white'},
    {selector: '#collapse_2 p', textColor: 'white'},
    {selector: '#collapse_2 p em', textColor: 'white'},
    {selector: '#collapse_2 em', textColor: 'white'},
    {selector: '#collapse_2 strong', textColor: '#80ff00'},
    {selector: '#collapse_2 p strong', textColor: '#80ff00'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#80ff00'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#80ff00'},
    {selector: 'table.grid tbody tr td strong', textColor: '#80ff00'},
    {selector: 'table.grid tbody tr td a', textColor: '#80ff00'},
    {selector: 'table.grid tbody tr td u', textColor: '#80ff00'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#80ff00'},
    {selector: '.footer .wrapper p span', textColor: '#80ff00'},
    ...
    {selector: '.button', color: '#333', borderColor: '#80ff00'},
    {selector: '.button2', color: '#333', borderColor: '#80ff00', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#80ff00'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#80ff00'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#80ff00'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#80ff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#80ff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#80ff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#80ff00'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#80ff00'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#80ff00'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#80ff00'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#80ff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#80ff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#80ff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#80ff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#80ff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#80ff00'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#80ff00'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#80ff00'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#80ff00'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#80ff00'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#80ff00'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#80ff00'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#80ff00'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#80ff00'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#80ff00'},
    {selector: '#tblEstimates_ID div', textColor: '#80ff00'},
    {selector: '#tblEstimates_Name div', textColor: '#80ff00'},
    {selector: '#tblEstimates_StringField div', textColor: '#80ff00'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#80ff00'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#80ff00'},
    {selector: '#tab1_pane ul li a', textColor: '#80ff00'},
    ...
    {selector: '#tab7_pane div', textColor: '#80ff00'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#80ff00'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#80ff00'},
    {selector: '#lblHeadingText', textColor: '#80ff00'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#80ff00'},
    {selector: '#lblMaxRec', textColor: '#80ff00'},
    {selector: '#divNote', textColor: '#80ff00'},
    ...
    {selector: '#createBy b', textColor: '#80ff00'},
    ...
    {selector: '.left label', textColor: '#80ff00'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#80ff00'},
    ...
    {selector: '#litIsLiveDate', textColor: '#80ff00'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#80ff00'},
    {selector: '#mLabel', textColor: '#80ff00'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#80ff00'},
    ...
    {selector: 'td a', textColor: '#80ff00'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#80ff00'},
