window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#ff00bf';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#ff00bf"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#ff00bf"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#ff00bf"},
    {selector: '#fldsetAdvanced', borderColor: '#ff00bf'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#ff00bf'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#ff00bf'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#ff00bf'},
    {selector: '#lblTicketDescription p a', textColor: '#ff00bf'},
    {selector: '#lblTicketDescription a', textColor: '#ff00bf'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#ff00bf'},
    {selector: '#lblTicketDescription p strong', textColor: '#ff00bf'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#ff00bf'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#ff00bf'},
    ...
    {selector: '#TicketDescription strong', textColor: '#ff00bf'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#ff00bf'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#ff00bf'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff00bf'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#ff00bf'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff00bf'},
    {selector: '#collapse_2 p strong', textColor: '#ff00bf'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#ff00bf'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#ff00bf'},
    {selector: 'table.grid tbody tr td strong', textColor: '#ff00bf'},
    {selector: 'table.grid tbody tr td a', textColor: '#ff00bf'},
    {selector: 'table.grid tbody tr td u', textColor: '#ff00bf'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#ff00bf'},
    {selector: '.footer .wrapper p span', textColor: '#ff00bf'},
    ...
    {selector: '.button', color: '#333', borderColor: '#ff00bf'},
    {selector: '.button2', color: '#333', borderColor: '#ff00bf', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#ff00bf'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#ff00bf'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#ff00bf'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#ff00bf'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#ff00bf'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#ff00bf'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#ff00bf'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#ff00bf'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#ff00bf'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#ff00bf'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#ff00bf'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#ff00bf'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#ff00bf'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#ff00bf'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#ff00bf'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#ff00bf'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#ff00bf'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#ff00bf'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#ff00bf'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#ff00bf'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#ff00bf'},
    {selector: '#tblEstimates_ID div', textColor: '#ff00bf'},
    {selector: '#tblEstimates_Name div', textColor: '#ff00bf'},
    {selector: '#tblEstimates_StringField div', textColor: '#ff00bf'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#ff00bf'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#ff00bf'},
    {selector: '#tab1_pane ul li a', textColor: '#ff00bf'},
    ...
    {selector: '#tab7_pane div', textColor: '#ff00bf'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#ff00bf'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#ff00bf'},
    {selector: '#lblHeadingText', textColor: '#ff00bf'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#ff00bf'},
    {selector: '#lblMaxRec', textColor: '#ff00bf'},
    {selector: '#divNote', textColor: '#ff00bf'},
    ...
    {selector: '#createBy b', textColor: '#ff00bf'},
    ...
    {selector: '.left label', textColor: '#ff00bf'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#ff00bf'},
    ...
    {selector: '#litIsLiveDate', textColor: '#ff00bf'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#ff00bf'},
    {selector: '#mLabel', textColor: '#ff00bf'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#ff00bf'},
    ...
    {selector: 'td a', textColor: '#ff00bf'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#ff00bf'},
