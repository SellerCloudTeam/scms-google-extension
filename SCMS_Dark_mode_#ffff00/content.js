window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#ffff00';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#ffff00"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#ffff00"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#ffff00"},
    {selector: '#fldsetAdvanced', borderColor: '#ffff00'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#ffff00'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#ffff00'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#ffff00'},
    {selector: '#lblTicketDescription p a', textColor: '#ffff00'},
    {selector: '#lblTicketDescription a', textColor: '#ffff00'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#ffff00'},
    {selector: '#lblTicketDescription p strong', textColor: '#ffff00'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#ffff00'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#ffff00'},
    ...
    {selector: '#TicketDescription strong', textColor: '#ffff00'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#ffff00'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#ffff00'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ffff00'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#ffff00'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ffff00'},
    {selector: '#collapse_2 p strong', textColor: '#ffff00'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#ffff00'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#ffff00'},
    {selector: 'table.grid tbody tr td strong', textColor: '#ffff00'},
    {selector: 'table.grid tbody tr td a', textColor: '#ffff00'},
    {selector: 'table.grid tbody tr td u', textColor: '#ffff00'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#ffff00'},
    {selector: '.footer .wrapper p span', textColor: '#ffff00'},
    ...
    {selector: '.button', color: '#333', borderColor: '#ffff00'},
    {selector: '.button2', color: '#333', borderColor: '#ffff00', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#ffff00'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#ffff00'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#ffff00'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#ffff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#ffff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#ffff00'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#ffff00'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#ffff00'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#ffff00'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#ffff00'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#ffff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#ffff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#ffff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#ffff00'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#ffff00'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#ffff00'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#ffff00'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#ffff00'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#ffff00'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#ffff00'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#ffff00'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#ffff00'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#ffff00'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#ffff00'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#ffff00'},
    {selector: '#tblEstimates_ID div', textColor: '#ffff00'},
    {selector: '#tblEstimates_Name div', textColor: '#ffff00'},
    {selector: '#tblEstimates_StringField div', textColor: '#ffff00'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#ffff00'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#ffff00'},
    {selector: '#tab1_pane ul li a', textColor: '#ffff00'},
    ...
    {selector: '#tab7_pane div', textColor: '#ffff00'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#ffff00'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#ffff00'},
    {selector: '#lblHeadingText', textColor: '#ffff00'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#ffff00'},
    {selector: '#lblMaxRec', textColor: '#ffff00'},
    {selector: '#divNote', textColor: '#ffff00'},
    ...
    {selector: '#createBy b', textColor: '#ffff00'},
    ...
    {selector: '.left label', textColor: '#ffff00'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#ffff00'},
    ...
    {selector: '#litIsLiveDate', textColor: '#ffff00'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#ffff00'},
    {selector: '#mLabel', textColor: '#ffff00'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#ffff00'},
    ...
    {selector: 'td a', textColor: '#ffff00'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#ffff00'},
