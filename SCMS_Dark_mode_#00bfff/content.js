window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#00bfff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#00bfff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#00bfff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#00bfff"},
    {selector: '#fldsetAdvanced', borderColor: '#00bfff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#00bfff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#00bfff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#00bfff'},
    {selector: '#lblTicketDescription p a', textColor: '#00bfff'},
    {selector: '#lblTicketDescription a', textColor: '#00bfff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#00bfff'},
    {selector: '#lblTicketDescription p strong', textColor: '#00bfff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#00bfff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#00bfff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#00bfff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#00bfff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#00bfff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#00bfff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#00bfff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#00bfff'},
    {selector: '#collapse_2 p strong', textColor: '#00bfff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#00bfff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#00bfff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#00bfff'},
    {selector: 'table.grid tbody tr td a', textColor: '#00bfff'},
    {selector: 'table.grid tbody tr td u', textColor: '#00bfff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#00bfff'},
    {selector: '.footer .wrapper p span', textColor: '#00bfff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#00bfff'},
    {selector: '.button2', color: '#333', borderColor: '#00bfff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#00bfff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#00bfff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#00bfff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#00bfff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#00bfff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#00bfff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#00bfff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#00bfff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#00bfff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#00bfff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#00bfff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#00bfff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#00bfff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#00bfff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#00bfff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#00bfff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#00bfff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#00bfff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#00bfff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#00bfff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#00bfff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#00bfff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#00bfff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#00bfff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#00bfff'},
    {selector: '#tblEstimates_ID div', textColor: '#00bfff'},
    {selector: '#tblEstimates_Name div', textColor: '#00bfff'},
    {selector: '#tblEstimates_StringField div', textColor: '#00bfff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#00bfff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#00bfff'},
    {selector: '#tab1_pane ul li a', textColor: '#00bfff'},
    ...
    {selector: '#tab7_pane div', textColor: '#00bfff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#00bfff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#00bfff'},
    {selector: '#lblHeadingText', textColor: '#00bfff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#00bfff'},
    {selector: '#lblMaxRec', textColor: '#00bfff'},
    {selector: '#divNote', textColor: '#00bfff'},
    ...
    {selector: '#createBy b', textColor: '#00bfff'},
    ...
    {selector: '.left label', textColor: '#00bfff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#00bfff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#00bfff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#00bfff'},
    {selector: '#mLabel', textColor: '#00bfff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#00bfff'},
    ...
    {selector: 'td a', textColor: '#00bfff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#00bfff'},
