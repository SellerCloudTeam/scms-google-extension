window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#0080ff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#0080ff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#0080ff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#0080ff"},
    {selector: '#fldsetAdvanced', borderColor: '#0080ff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#0080ff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#0080ff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#0080ff'},
    {selector: '#lblTicketDescription p a', textColor: '#0080ff'},
    {selector: '#lblTicketDescription a', textColor: '#0080ff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#0080ff'},
    {selector: '#lblTicketDescription p strong', textColor: '#0080ff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#0080ff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#0080ff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#0080ff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#0080ff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#0080ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#0080ff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#0080ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#0080ff'},
    {selector: '#collapse_2 p strong', textColor: '#0080ff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#0080ff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#0080ff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#0080ff'},
    {selector: 'table.grid tbody tr td a', textColor: '#0080ff'},
    {selector: 'table.grid tbody tr td u', textColor: '#0080ff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#0080ff'},
    {selector: '.footer .wrapper p span', textColor: '#0080ff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#0080ff'},
    {selector: '.button2', color: '#333', borderColor: '#0080ff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#0080ff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#0080ff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#0080ff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#0080ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#0080ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#0080ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#0080ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#0080ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#0080ff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#0080ff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#0080ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#0080ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#0080ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#0080ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#0080ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#0080ff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#0080ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#0080ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#0080ff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#0080ff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#0080ff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#0080ff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#0080ff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#0080ff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#0080ff'},
    {selector: '#tblEstimates_ID div', textColor: '#0080ff'},
    {selector: '#tblEstimates_Name div', textColor: '#0080ff'},
    {selector: '#tblEstimates_StringField div', textColor: '#0080ff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#0080ff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#0080ff'},
    {selector: '#tab1_pane ul li a', textColor: '#0080ff'},
    ...
    {selector: '#tab7_pane div', textColor: '#0080ff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#0080ff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#0080ff'},
    {selector: '#lblHeadingText', textColor: '#0080ff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#0080ff'},
    {selector: '#lblMaxRec', textColor: '#0080ff'},
    {selector: '#divNote', textColor: '#0080ff'},
    ...
    {selector: '#createBy b', textColor: '#0080ff'},
    ...
    {selector: '.left label', textColor: '#0080ff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#0080ff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#0080ff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#0080ff'},
    {selector: '#mLabel', textColor: '#0080ff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#0080ff'},
    ...
    {selector: 'td a', textColor: '#0080ff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#0080ff'},
