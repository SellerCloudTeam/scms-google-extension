window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#bf00ff';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#bf00ff"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#bf00ff"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#bf00ff"},
    {selector: '#fldsetAdvanced', borderColor: '#bf00ff'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#bf00ff'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#bf00ff'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#bf00ff'},
    {selector: '#lblTicketDescription p a', textColor: '#bf00ff'},
    {selector: '#lblTicketDescription a', textColor: '#bf00ff'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#bf00ff'},
    {selector: '#lblTicketDescription p strong', textColor: '#bf00ff'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#bf00ff'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#bf00ff'},
    ...
    {selector: '#TicketDescription strong', textColor: '#bf00ff'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#bf00ff'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#bf00ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#bf00ff'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#bf00ff'},
    ...
    {selector: '#collapse_2 strong', textColor: '#bf00ff'},
    {selector: '#collapse_2 p strong', textColor: '#bf00ff'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#bf00ff'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#bf00ff'},
    {selector: 'table.grid tbody tr td strong', textColor: '#bf00ff'},
    {selector: 'table.grid tbody tr td a', textColor: '#bf00ff'},
    {selector: 'table.grid tbody tr td u', textColor: '#bf00ff'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#bf00ff'},
    {selector: '.footer .wrapper p span', textColor: '#bf00ff'},
    ...
    {selector: '.button', color: '#333', borderColor: '#bf00ff'},
    {selector: '.button2', color: '#333', borderColor: '#bf00ff', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#bf00ff'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#bf00ff'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#bf00ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#bf00ff'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#bf00ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#bf00ff'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#bf00ff'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#bf00ff'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#bf00ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#bf00ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#bf00ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#bf00ff'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#bf00ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#bf00ff'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#bf00ff'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#bf00ff'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#bf00ff'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#bf00ff'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#bf00ff'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#bf00ff'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#bf00ff'},
    {selector: '#tblEstimates_ID div', textColor: '#bf00ff'},
    {selector: '#tblEstimates_Name div', textColor: '#bf00ff'},
    {selector: '#tblEstimates_StringField div', textColor: '#bf00ff'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#bf00ff'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#bf00ff'},
    {selector: '#tab1_pane ul li a', textColor: '#bf00ff'},
    ...
    {selector: '#tab7_pane div', textColor: '#bf00ff'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#bf00ff'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#bf00ff'},
    {selector: '#lblHeadingText', textColor: '#bf00ff'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#bf00ff'},
    {selector: '#lblMaxRec', textColor: '#bf00ff'},
    {selector: '#divNote', textColor: '#bf00ff'},
    ...
    {selector: '#createBy b', textColor: '#bf00ff'},
    ...
    {selector: '.left label', textColor: '#bf00ff'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#bf00ff'},
    ...
    {selector: '#litIsLiveDate', textColor: '#bf00ff'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#bf00ff'},
    {selector: '#mLabel', textColor: '#bf00ff'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#bf00ff'},
    ...
    {selector: 'td a', textColor: '#bf00ff'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#bf00ff'},
