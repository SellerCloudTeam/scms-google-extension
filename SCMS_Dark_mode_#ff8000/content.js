window.onload = function() {
    ...
    if (theDamnSendEmailButton) {
        ...
        theDamnSendEmailButton.style.borderColor = '#ff8000';
...
const targetElements = [  
    ...
    {selector: '#topsearch ul li.active a strong', textColor: "#ff8000"},
    ...
    {selector: '#pnlKS ul li.active a strong', textColor: "#ff8000"},
    ...
    {selector: '#fldsetAdvanced ul li.active a strong', backgroundColor: '#999999', textColor: "#ff8000"},
    {selector: '#fldsetAdvanced', borderColor: '#ff8000'},
    {selector: '#fldsetAdvanced>legend', textColor: 'white'},
    {selector: '#mainContent', color: 'black', removeOverflow: true},
    {selector: '#mainContent', borderColor: '#ff8000'},
    ...
    {selector: '#mainContent>fieldset>p', textColor: '#ff8000'},
    ...
    {selector: '#lblTicketDescription', borderColor: '#ff8000'},
    {selector: '#lblTicketDescription p a', textColor: '#ff8000'},
    {selector: '#lblTicketDescription a', textColor: '#ff8000'},
    ...
    {selector: '#lblTicketDescription strong', textColor: '#ff8000'},
    {selector: '#lblTicketDescription p strong', textColor: '#ff8000'},
    ...
    {selector: '#lblTicketDescription p u', textColor: '#ff8000'},
    {selector: '#lblTicketDescription ol', textColor: 'white'},
    {selector: '#lblTicketDescription b', textColor: '#ff8000'},
    ...
    {selector: '#TicketDescription strong', textColor: '#ff8000'},
    {selector: '#TicketDescription br', textColor: 'white'},
    {selector: '#TicketDescription a', textColor: 'white'},
    {selector: '#TicketDescription b', textColor: '#ff8000'},
    ...
    {selector: '#lblNotes p a', backgroundColor: 'black', color: '#ff8000'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff8000'},
    {selector: '#collapse_2 hr', borderColor: '#800000'},
    {selector: '#collapse_2 b', textColor: '#ff8000'},
    ...
    {selector: '#collapse_2 strong', textColor: '#ff8000'},
    {selector: '#collapse_2 p strong', textColor: '#ff8000'},
    {selector: '#collapse_2 p text', textColor: 'white'},
    {selector: '#collapse_2 p u', textColor: '#ff8000'},
    ...
    {selector: 'table.grid tbody tr td p strong', textColor: '#ff8000'},
    {selector: 'table.grid tbody tr td strong', textColor: '#ff8000'},
    {selector: 'table.grid tbody tr td a', textColor: '#ff8000'},
    {selector: 'table.grid tbody tr td u', textColor: '#ff8000'},
    ...
    {selector: '.footer .wrapper p a', textColor: '#ff8000'},
    {selector: '.footer .wrapper p span', textColor: '#ff8000'},
    ...
    {selector: '.button', color: '#333', borderColor: '#ff8000'},
    {selector: '.button2', color: '#333', borderColor: '#ff8000', backgroundImage: "none"},
    ...
    {selector: '.panel.panel-default', borderColor: '#ff8000'},
    {selector: '#jqgh_tblAuditHistoryList_Operationtype', textColor: '#ff8000'},
    {selector: '#jqgh_tblAuditHistoryList_FullName', textColor: '#ff8000'},
    {selector: '#jqgh_tblAuditHistoryList_ModifiedDate', textColor: '#ff8000'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedByName', textColor: '#ff8000'},
    {selector: '#jqgh_tblFollowUpHistoryList_CreatedOn', textColor: '#ff8000'},
    {selector: '#jqgh_tblFollowUpHistoryList_IsFollowedUp', textColor: '#ff8000'},
    {selector: '#jqgh_tblTicketEmailHistory_ActionType', textColor: '#ff8000'},
    {selector: '#jqgh_tblTicketEmailHistory_ClientContactNames', textColor: '#ff8000'},
    {selector: '#jqgh_tblTicketEmailHistory_SentOn', textColor: '#ff8000'},
    {selector: '#jqgh_tblTicketEmailHistory_TicketId', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_Operationtype', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ClientContactName', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_FullName', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientContactAuditHistoryList_ModifiedDate', textColor: '#ff8000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_Operationtype', textColor: '#ff8000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_PSProjectDesc', textColor: '#ff8000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_FullName', textColor: '#ff8000'},
    {selector: '#jqgh_tblPSProjectAuditHistoryList_ModifiedDate', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_Operationtype', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_SubscriptionTypeName', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_FullName', textColor: '#ff8000'},
    {selector: '#jqgh_tblClientSubscriptionAuditHistoryList_ModifiedDate', textColor: '#ff8000'},
    {selector: '#jqgh_tblShowExistingRequest_ClientName', textColor: '#ff8000'},
    {selector: '#jqgh_tblShowExistingRequest_RequestCreatedByEmployee', textColor: '#ff8000'},
    {selector: '#jqgh_tblShowExistingRequest_RequestedCreatedOn', textColor: '#ff8000'},
    {selector: '#jqgh_tblShowExistingRequest_ReasonForUpdate', textColor: '#ff8000'},
    {selector: '#jqgh_tblShowExistingRequest_TicketIds', textColor: '#ff8000'},
    ...
    {selector: '#tblListWorklog tbody tr td i', textColor: '#ff8000'},    
    ...
    {selector: '#tblPriorityHistoryList_Operationtype', textColor: '#ff8000'},
    {selector: '#tblPriorityHistoryList_FullName', textColor: '#ff8000'},
    {selector: '#tblPriorityHistoryList_CreatedOn', textColor: '#ff8000'},
    {selector: '#tblEstimates_ID div', textColor: '#ff8000'},
    {selector: '#tblEstimates_Name div', textColor: '#ff8000'},
    {selector: '#tblEstimates_StringField div', textColor: '#ff8000'},
    {selector: '#tblShowExistingRequest_TicketIds', textColor: '#ff8000'},
    ...
    {selector: '#tab1_pane h3 a', textColor: '#ff8000'},
    {selector: '#tab1_pane ul li a', textColor: '#ff8000'},
    ...
    {selector: '#tab7_pane div', textColor: '#ff8000'},
    ...
    {selector: '.modal-content', background: 'black', borderColor: '#ff8000'},
    ...
    {selector: '#lblCurrentDBVSVersion b', textColor: '#ff8000'},
    {selector: '#lblHeadingText', textColor: '#ff8000'},
    {selector: '#lblStatus', textColor: 'white'},
    {selector: '#lblIsLive', textColor: '#ff8000'},
    {selector: '#lblMaxRec', textColor: '#ff8000'},
    {selector: '#divNote', textColor: '#ff8000'},
    ...
    {selector: '#createBy b', textColor: '#ff8000'},
    ...
    {selector: '.left label', textColor: '#ff8000'},
    {selector: '#chkCategory tbody tr td label ', textColor: 'white'},
    {selector: '#yt', textColor: '#ff8000'},
    ...
    {selector: '#litIsLiveDate', textColor: '#ff8000'},
    {selector: '#dropdownMenu1', color: '#333', borderColor: '#ff8000'},
    {selector: '#mLabel', textColor: '#ff8000'},
    ...
    {selector: '#pnlSearch fieldset', borderColor: '#ff8000'},
    ...
    {selector: 'td a', textColor: '#ff8000'},
    ...
    {selector: '.navigation', color: '#333', borderColor: '#ff8000'},
